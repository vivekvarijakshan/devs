		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Kaizen Process",
									"targetURL": "#kaizenprocessnspworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"kaizenprocessnspworkflowuimodule-display": {
								"semanticObject": "kaizenprocessnspworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=kaizenprocessnsp.workflowuimodule",
									"url": sap.ui.require.toUrl("kaizenprocessnsp/workflowuimodule")
								}
							}
						}
					}
